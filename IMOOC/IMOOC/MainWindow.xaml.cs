...
namespace IMOOC
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            string Path1 = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\IMOOC\\" + MyHttpWebRequest.CurrUser.UserName;
        ...
        {
            string JsonPath = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\IMOOC\\"+ MyHttpWebRequest.CurrUser.UserName+"\\AppConfig.json";
            try
            {
