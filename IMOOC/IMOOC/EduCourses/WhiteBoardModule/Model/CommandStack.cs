...
namespace IMOOC.EduCourses.WhiteBoardModule
{
    ...
    public class StrokesAddedOrRemovedCI : CommandItem
    {
        ...
        public StrokesAddedOrRemovedCI(CommandStack commandStack, InkCanvasEditingMode editingMode, 
            StrokeCollection added, StrokeCollection removed, int editingOperationCount)
            : base(commandStack)
        {
    ...
    class SelectionMovedOrResizedCI : CommandItem
    {
        ...
        public SelectionMovedOrResizedCI(CommandStack commandStack, StrokeCollection selection, 
            Rect newrect, Rect oldrect, int editingOperationCount)
            : base(commandStack)
        {
