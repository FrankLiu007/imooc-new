...
namespace Public
{
    static class Log
    {
        ...
        {
            string savePath = @"D:\善而教\error_log.txt";
            string saveFolder = @"D:\善而教";
            if (!Directory.Exists(saveFolder))
            {
                ...
                {
                   savePath = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\善而教\\AppConfig\\error_log.txt";
                   saveFolder = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\善而教\\AppConfig\\";
                   Directory.CreateDirectory(saveFolder);
                }
