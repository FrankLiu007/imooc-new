...
namespace IMOOC.EduCourses
{
    ...
    public partial class CourseControl : UserControl
    {
        ...
        private RadioButton LastMenuRadioBtn; 
        ...
        public string defaultCoursePath;
        ...
        {
            InitializeComponent();
            defaultCoursePath = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\善而教";

            viewModel = new CoursesViewModel();
            DataContext = viewModel;
            rect = new Rect();
            LastMenuRadioBtn = null;
        ...
        private void UserControl_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (Public.Register.CheckRegister())
            {
                registerLable.Visibility = Visibility.Hidden;
            }
        }
        ...
        public void GotoBanshu()
        {
            ...
            viewModel.CurrCourse.IsBanshu = true;
            LastMenuRadioBtn = BanshuMenu;
        }
        ...
        public void GotoPPT()
        {
            ...
            viewModel.CurrCourse.IsBanshu = false;
            LastMenuRadioBtn = PPTMenu;
            PPTMenu.IsChecked = true;
        }

        public void GotoEdit()
        {
            if (!viewModel.CurrCourse.IsBanshu)
            {
                GotoBanshu();
        ...
        public void GotoInsert()
        {
            ...
            LastMenuRadioBtn = InsertMenu;
            InsertMenu.IsChecked = true;
        }
        ...
        public void GotoRecourdMenu()
        {
            ...
            LastMenuRadioBtn = RecourdMenu;
            RecourdMenu.IsChecked = true;
        }
        ...
        {
           var savePath = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\善而教\\";
           var filename = "未命名";
            try
            {
        ...
        {
            Utils.RegisterWin registerWin = new RegisterWin();
            registerWin.ShowDialog();
            if (Public.Register.IsRegister)
            {
                registerLable.Visibility = Visibility.Hidden;
            }
        }
