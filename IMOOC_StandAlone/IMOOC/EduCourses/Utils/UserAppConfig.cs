...
namespace IMOOC.EduCourses.Utils
{
    public static class UserAppConfigStatic
    {
        ...
        public static string SavePath { get; set; } = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\善而教";
    ...
    public class UserAppConfig
    {
        ...
        public UserAppConfig()
        {
            ...
            PenMode = false;
            BoardMode = true;
            SavePath = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\善而教";
            IsDebugInfoOn = true;
            IsStylusOnly = false;
            Port = 8911;
        }
